...
import com.iiitb.POC.JwtUtil.JwtAuthenticationEntryPoint;
import com.iiitb.POC.JwtUtil.JwtFilter;
import com.iiitb.POC.JwtUtil.JwtUserDetailsService;
import com.iiitb.POC.JwtUtil.TokenManager;
...
public class AuthenticationController {
    ...
    public int send_otp(@RequestParam("phone_number") String mobile_number,@RequestParam("password") String password)

    {
        System.out.println("Hello?");
        String result=this.authenticationService.send_otp(mobile_number,password);
